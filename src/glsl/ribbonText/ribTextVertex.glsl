...
vec3 calculateSurfacePoint(float t, float px, float py, float wStep) {
  ...
  vec3 projectedN = vec3(-0.2, 1.0, 0.0);
...
float calculateElevation ( vec3 position ) {
  float waveFreqPath1 = 0.12; float waveFreqWidth1 = 1.2; float waveAmp1 = 2.99;
  float waveFreqPath2 = 0.3; float waveFreqWidth2 = 2.3; float waveAmp2 = 2.36; float timeSpeed2 = 0.6;
  float waveFreqPath3 = 0.17; float waveFreqWidth3 = 1.3; float waveAmp3 = 2.98; float timeSpeed3 = 0.4;
